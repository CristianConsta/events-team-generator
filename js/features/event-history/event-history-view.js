(function initEventHistoryView(global) {
    ...
    function renderHistoryList(container, records, options) {
        ...
        records.forEach(function(record) {
            ...
            sourceBadge.textContent = source === 'alliance'
                ? t('event_history_source_alliance')
                : t('event_history_source_personal');
            ...
            if (isOwn) {
                ...
                deleteBtn.setAttribute('aria-label', t('event_history_delete'));
                // Trash SVG icon
